...
dirichlet_calibration = Dirichlet_NN(l2=0.01, classes=12, comp=True, max_epochs=20, patience=3, lr=0.0001)
...
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_All_ECE.txt", "wb") as fp_ECE:
    pickle.dump(res_list_All_ECE, fp_ECE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_All_MCE.txt", "wb") as fp_MCE:
    pickle.dump(res_list_All_MCE, fp_MCE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_All_SCE.txt", "wb") as fp_SCE:
    pickle.dump(res_list_All_SCE, fp_SCE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_All_ACE.txt", "wb") as fp_ACE:
    pickle.dump(res_list_All_ACE, fp_ACE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_Boundary_ECE.txt", "wb") as fp_B_ECE:
    pickle.dump(res_list_Boundary_ECE, fp_B_ECE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_Boundary_MCE.txt", "wb") as fp_B_MCE:
    pickle.dump(res_list_Boundary_MCE, fp_B_MCE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_Boundary_SCE.txt", "wb") as fp_B_SCE:
    pickle.dump(res_list_Boundary_SCE, fp_B_SCE, protocol=2)
with open("./CamVid_result/"+"Dirichlet_CamVid_ICCV_Boundary_ACE.txt", "wb") as fp_B_ACE:
