...
with open("./CamVid_result/"+"ETS_CamVid_ICCV_Local_36_ECE.txt", "wb") as fp_ECE:
    pickle.dump(res_list_Local_ECE, fp_ECE, protocol=2)
with open("./CamVid_result/"+"ETS_CamVid_ICCV_Local_36_MCE.txt", "wb") as fp_MCE:
    pickle.dump(res_list_Local_MCE, fp_MCE, protocol=2)
with open("./CamVid_result/"+"ETS_CamVid_ICCV_Local_36_SCE.txt", "wb") as fp_SCE:
    pickle.dump(res_list_Local_SCE, fp_SCE, protocol=2)
with open("./CamVid_result/"+"ETS_CamVid_ICCV_Local_36_ACE.txt", "wb") as fp_ACE:
